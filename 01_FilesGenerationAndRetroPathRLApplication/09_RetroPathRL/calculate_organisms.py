...
def __run__():
    ...
    detectable_cmpds = import_organism_from_csv('{}/data/general_sink.csv'.format(directory_for_saving), add_Hs = True)
    ...
    Test_organism = ChemicalCompoundState(state_name = "Test", compound_list = [compound_1, compound_6, compound_3459])
    detectable_cmpds = import_organism_from_csv('{}/data/general_sink.csv'.format(directory_for_saving), add_Hs = False)
